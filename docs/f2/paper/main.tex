...
% Direction labels on right
\draw[dotted, gray] (4, 0.5) -- (4, -8.5);
\node[dirlabel] at (5.2, -1.3) {Direction 1:\\What does BT\\recover?};
\node[dirlabel] at (5.2, -4.6) {Direction 3:\\What's lost\\when hidden?};
\node[dirlabel] at (5.2, -7.2) {Direction 2:\\How precise\\must spec be?};

% Bracket for D1 scope
\draw[decorate, decoration={brace, amplitude=4pt}, gray]
  (3.8, -0.7) -- (3.8, -3.3);
% Bracket for D3 scope
\draw[decorate, decoration={brace, amplitude=4pt}, gray]
  (3.8, -3.5) -- (3.8, -5.8);
% Bracket for D2 scope
\draw[decorate, decoration={brace, amplitude=4pt}, gray]
  (3.8, -6.0) -- (3.8, -8.3);
...
\caption{System pipeline. Each step flows strictly downward: data
  ...
  scope of each research direction.}
\label{fig:pipeline}
\end{figure}
